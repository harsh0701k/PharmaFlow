...
module.exports = {
  ...
  async up(queryInterface) {
    ...
    await queryInterface.bulkInsert('roles', [
      ...
      {
        id: getId('hospital_admin'),
        name: 'hospital_admin',
        createdAt,
        updatedAt,
      },

      { id: getId('doctor'), name: 'doctor', createdAt, updatedAt },

      { id: getId('pharmacist'), name: 'pharmacist', createdAt, updatedAt },
...
primary key ("roles_permissionsId", "permissionId")
    ...
    await queryInterface.bulkInsert('rolesPermissionsPermissions', [
...

      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('hospital_admin'),
        permissionId: getId('CREATE_USERS'),
      },
...

      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('doctor'),
        permissionId: getId('CREATE_APPOINTMENTS'),
      },
...

      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('pharmacist'),
        permissionId: getId('CREATE_INVENTORIES'),
      },
