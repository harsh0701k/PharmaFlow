    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Inventories Pharmacy</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {organizations.inventories_pharmacy &&
                      Array.isArray(organizations.inventories_pharmacy) &&
                      organizations.inventories_pharmacy.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
              ...
              {!organizations?.inventories_pharmacy?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
