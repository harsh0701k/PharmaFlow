    ...
    <>
      ...
      <SectionMain>
        <SectionTitleLineWithButton
          ...
          title={removeLastCharacter('View inventories')}
          main
        >
          {''}
        </SectionTitleLineWithButton>
        <CardBox>
          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>MedicineName</p>
            <p>{inventories?.medicine_name}</p>
          </div>

          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>Quantity</p>
            <p>{inventories?.quantity || 'No data'}</p>
          </div>

          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>Pharmacy</p>

            <p>{inventories?.pharmacy?.name ?? 'No data'}</p>
          </div>
          ...
          {hasPermission(currentUser, 'READ_ORGANIZATIONS') && (
            <div className={'mb-4'}>
              ...
              <p>{inventories?.organization?.name ?? 'No data'}</p>
            </div>
          )}
