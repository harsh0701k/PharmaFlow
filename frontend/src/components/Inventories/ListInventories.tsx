...
const ListInventories = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_INVENTORIES');
              ...
              >
                ...
                >
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>MedicineName</p>
                    <p className={'line-clamp-2'}>{item.medicine_name}</p>
                  </div>
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/inventories/inventories-edit/?id=${item.id}`}
                  pathView={`/inventories/inventories-view/?id=${item.id}`}
